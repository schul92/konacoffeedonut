...
export const menuItemCategories: MenuItemCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Açaí Oahu', image: acaiItem('acai-oahu'), price: '13.95 / 18.95' },
      { name: 'Açaí Paradise', image: acaiItem('acai-paradise'), price: '13.95 / 18.95' },
      { name: 'Açaí Colada', image: acaiItem('acai-colada'), price: '13.95 / 18.95' },
      { name: 'Papaya Special', image: acaiItem('acai-papaya'), price: '13.95 / 18.95' },
