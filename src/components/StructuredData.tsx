...
export default function StructuredData({ locale }: StructuredDataProps) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: `https://www.konacoffeedonut.com/${locale}/about-kona-coffee`,
      },
      {
        '@type': 'ListItem',
        position: 4,
        name: 'FAQ',
        item: `https://www.konacoffeedonut.com/${locale}/faq`,
      },
    ],
  };
  ...
  const videoSchema = {
    ...
    thumbnailUrl: 'https://www.konacoffeedonut.com/videos/waikiki_1_poster.webp',
    uploadDate: '2026-01-15T08:00:00+00:00',
    contentUrl: 'https://www.konacoffeedonut.com/videos/waikiki_1_web.mp4',
  ...
  const productSchema = {
    ...
    material: 'Rice flour (mochiko), Honolulu Coffee beans',
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: {
          ...
          brand: { '@type': 'Brand', name: 'MOCHILAND' },
          offers: { '@type': 'Offer', priceCurrency: 'USD', price: '3.50', availability: 'https://schema.org/InStock', url: `https://www.konacoffeedonut.com/${locale}/menu` },
        },
      },
      {
        '@type': 'ListItem',
        ...
        item: {
          ...
          offers: { '@type': 'Offer', priceCurrency: 'USD', price: '4.00', availability: 'https://schema.org/InStock', url: `https://www.konacoffeedonut.com/${locale}/menu` },
        },
      },
      {
        '@type': 'ListItem',
        ...
        item: {
          ...
          brand: { '@type': 'Brand', name: 'Kona Coffee Donut?' },
          offers: { '@type': 'Offer', priceCurrency: 'USD', price: '12.00', availability: 'https://schema.org/InStock', url: `https://www.konacoffeedonut.com/${locale}/menu` },
        },
      },
      {
        '@type': 'ListItem',
        ...
        item: {
          ...
          brand: { '@type': 'Brand', name: 'Kona Coffee Donut?' },
          offers: { '@type': 'Offer', priceCurrency: 'USD', price: '6.00', availability: 'https://schema.org/InStock', url: `https://www.konacoffeedonut.com/${locale}/menu` },
        },
      },
      {
        '@type': 'ListItem',
        ...
        item: {
          ...
          brand: { '@type': 'Brand', name: 'Kona Coffee Donut?' },
          offers: { '@type': 'Offer', priceCurrency: 'USD', price: '10.00', availability: 'https://schema.org/InStock', url: `https://www.konacoffeedonut.com/${locale}/menu` },
        },
      },
    ],
  };
