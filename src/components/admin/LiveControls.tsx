...
export default function LiveControls({ generatedAt, intervalMs = 45_000 }: { generatedAt: number; intervalMs?: number }) {
  ...
  return (
    <div className="flex items-center gap-2.5 text-xs text-[var(--ad-fg-muted)]">
      ...
      <button
        onClick={refreshNow}
        disabled={isPending}
        className="rounded-lg border border-[var(--ad-border)] px-2.5 py-1 font-medium text-[var(--ad-fg-muted)] transition-colors hover:bg-[var(--ad-track)] disabled:opacity-50"
      >
