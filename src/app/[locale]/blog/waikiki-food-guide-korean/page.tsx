    ...
    pricing: {
      ...
      categories: [
        ...
        },
        {
          name: '도넛 & 디저트',
          items: [
            { item: '모찌 도넛 (3개 박스)', price: '$11.25 (개당 약 $3.75)', krw: '약 15,500원' },
            { item: '말라사다 (1개)', price: '$3.95~$4.95', krw: '약 5,500~6,800원' },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: '커피 한 잔은 $5~$8(약 6,900~11,000원), 도넛류는 $3.75~$5(약 5,200~6,900원), 빙수는 $12~$16(약 16,500~22,000원) 정도입니다. 한국 카페 가격과 비교하면 다소 비싸지만, 하와이 물가와 호놀룰루 커피 사용을 감안하면 합리적인 가격대입니다.',
        },
        {
    ...
    pricing: {
      ...
      categories: [
        ...
        },
        {
          ...
          items: [
            { item: 'Mochi Donut (box of 3)', price: '$11.25 (~$3.75 each)', krw: 'approx. 15,500 KRW' },
            { item: 'Malasada (1pc)', price: '$3.95–$4.95', krw: 'approx. 5,500–6,800 KRW' },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Coffee is $5–$8 (approx. 6,900–11,000 KRW), donuts $3.75–$5 (approx. 5,200–6,900 KRW), bingsu $12–$16 (approx. 16,500–22,000 KRW). A bit pricier than Korean cafes, but reasonable for Hawaii and Honolulu Coffee beans.',
        },
        {
  ...
  ja: {
    ...
    pricing: {
      ...
      categories: [
        ...
        { name: 'ドーナツ＆デザート', items: [
          { item: 'モチドーナツ（3個ボックス）', price: '$11.25（約$3.75/個）', krw: '約1,700円' },
          { item: 'マラサダ（1個）', price: '$3.95〜$4.95', krw: '約590〜740円' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'ワイキキの食事の予算は？', a: 'コーヒー$5〜$8、ドーナツ$3.75〜$5、ビンス$12〜$16程度です。' },
  ...
  zh: {
    ...
    pricing: {
      ...
      categories: [
        ...
        { name: '甜甜圈和甜品', items: [
          { item: '麻糬甜甜圈（3个装）', price: '$11.25（约$3.75/个）', krw: '约82元' },
          { item: '马拉萨达（1个）', price: '$3.95–$4.95', krw: '约29–36元' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: '威基基吃饭预算多少？', a: '咖啡$5–$8，甜甜圈$3.75–$5，刨冰$12–$16左右。' },
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '커피 한 잔은 $5~$8(약 6,900~11,000원), 도넛류는 $3.75~$5(약 5,200~6,900원), 빙수는 $12~$16(약 16,500~22,000원) 정도입니다.',
      },
    },
    {
      '@type': 'Question',
