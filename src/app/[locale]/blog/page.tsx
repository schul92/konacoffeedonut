    ...
    posts: [
      {
        ...
        image: '/images/blog/late-night-dessert-waikiki.jpeg',
        category: 'Food Guide',
        title: 'Late Night Dessert in Waikiki: Bingsu & Donuts Until 9 PM',
        excerpt: 'Most Waikiki bakeries close by 6 PM. Kona Coffee Donut serves bingsu, mochi donuts, malasadas and boba cans until 9 PM daily, 5 minutes from the beach.',
        readTime: 5,
      },
      {
        slug: 'what-is-ube-waikiki',
        image: '/images/blog/what-is-ube-waikiki.jpeg',
        category: 'Food Guide',
        title: 'What Is Ube? Flavor, Ube vs Taro & Where to Try It in Waikiki',
        excerpt: 'Ube is a Filipino purple yam — not taro, not sweet potato — with a nutty vanilla-coconut flavor. Ube mochi donuts, bingsu and lattes in Waikiki.',
        readTime: 6,
      },
      {
        slug: 'mochi-donut-vs-regular-donut',
        image: '/images/blog/mochi-donut-vs-regular-donut.jpeg',
        category: 'Comparison',
        title: 'Mochi Donut vs Regular Donut: What\'s Actually Different',
        excerpt: 'Rice-flour chew vs wheat fluff — dough, texture, sweetness, freshness window and how to eat one. Try both (mochi donut + malasada) in Waikiki.',
        readTime: 6,
      },
      {
      ...
      },
      {
        ...
        category: 'Food Guide',
        title: 'Breakfast in Waikiki Open at 7 AM: Donuts, Musubi & Kona Coffee',
        excerpt: 'Spam musubi from $2.95, fresh mochi donuts and malasadas, and 100% Kona coffee — a real Hawaii breakfast under $10, 5 minutes from the beach.',
        readTime: 5,
      },
      {
        slug: 'boba-waikiki',
        image: '/images/blog/boba-waikiki.jpeg',
        category: 'Food Guide',
        title: 'Boba in Waikiki: Canned Milk Tea, Brown Sugar & Ube at Mochi Land',
        excerpt: 'Six canned boba milk teas at $8.95 — classic, brown sugar, ube, coffee, Thai tea, matcha — sealed to go for the beach.',
        readTime: 4,
      },
      {
        slug: 'musubi-waikiki',
        image: '/images/blog/musubi-waikiki.jpeg',
        category: 'Food Guide',
        title: 'Spam Musubi in Waikiki from $2.95: Made Fresh Daily',
        excerpt: "Hawaii's favorite grab-and-go, made fresh in-store: classic spam, teriyaki, egg, shiso wakame, and shrimp avocado.",
        readTime: 4,
      },
      {
      ...
      },
      {
        ...
        image: '/images/blog/must-try-foods-waikiki.jpg',
        category: 'Food Guide',
        title: "10 Must-Try Foods in Waikiki (2026 Local's List)",
        excerpt: 'Malasadas, poke, plate lunch, garlic shrimp, shave ice, bingsu, mochi donuts, 100% Kona coffee, açaí bowls and Korean corn dogs — what makes each one Hawaiian and where to get it near the beach.',
        readTime: 9,
      },
      {
        slug: 'korean-corn-dog-honolulu-viral',
        image: '/images/blog/korean-corn-dog-honolulu-viral.jpg',
        category: 'Korean Food',
        title: 'Korean Corn Dogs in Honolulu: Why They Went Viral & Where to Get One',
        excerpt: 'Rice-flour batter, a foot-long mozzarella pull, sugar on a hot dog. Why the Korean corn dog took over TikTok, all 6 styles explained, and where to get one fried to order in Honolulu.',
        readTime: 7,
      },
      {
        slug: 'best-poke-waikiki',
        image: '/images/blog/best-poke-waikiki.jpg',
        category: 'Food Guide',
        title: 'Best Poke in Waikiki (2026): Where Locals Actually Buy It',
        excerpt: 'Real Hawaiian poke is sold by the pound at fish counters, not from a topping bar. The spots locals use in Waikīkī and Kapahulu, how to order, 2026 prices, and where to go for dessert after.',
        readTime: 7,
      },
      {
      ...
      },
      {
        ...
        category: 'Coffee',
        title: 'The Story of Matcha: From Japanese Tea Ceremony to Your Cup (2026)',
        excerpt: 'The full story of matcha — its history from Zen temples and the Japanese tea ceremony, ceremonial vs culinary grade, its benefits, and where to drink a freshly whisked cup in Waikiki.',
        readTime: 8,
      },
      {
        slug: 'matcha-vs-hojicha-waikiki',
      ...
      {
        slug: 'best-matcha-drinks-waikiki',
        image: '/images/blog/best-matcha-drinks-waikiki.jpeg',
        category: 'Coffee',
        title: 'Best Matcha Drinks in Waikiki: Every Flavor Ranked (2026)',
        excerpt: 'The best matcha in Waikiki, ranked — real whisked Japanese matcha led by our bestselling Strawberry Matcha, plus classic, tropical, hojicha and iced options.',
        readTime: 6,
      },
      {
        slug: 'matcha-vs-coffee-waikiki',
        image: '/images/blog/matcha-vs-coffee-waikiki.jpeg',
        category: 'Coffee',
        title: 'Matcha vs Coffee: Which Should You Drink? (2026)',
        excerpt: 'No universal winner — matcha gives a calm ~60–70mg lift via L-theanine, coffee a stronger ~95–120mg kick. At Kona Coffee Donut? you can try both.',
        readTime: 8,
      },
      {
        slug: 'matcha-benefits-waikiki',
        image: '/images/blog/matcha-benefits-waikiki.jpeg',
        category: 'Coffee',
        title: 'Matcha Benefits & Caffeine: Is Matcha Good for You? (2026)',
        excerpt: 'Is matcha good for you? Matcha benefits explained — antioxidants (EGCG), L-theanine for calm focus, metabolism & skin, plus how much caffeine matcha has vs coffee.',
        readTime: 6,
      },
      {
        slug: 'iced-matcha-latte-waikiki',
        image: '/images/blog/iced-matcha-latte-waikiki.jpeg',
        category: 'Coffee',
        title: 'Iced Matcha Latte in Waikiki: The Perfect Beach-Day Drink (2026)',
        excerpt: 'Where to get the best iced matcha latte in Waikiki — real stone-ground matcha (not syrup), not too sweet, with strawberry, mango & oat/almond/soy options near the beach.',
        readTime: 6,
      },
      {
        slug: 'hojicha-latte-waikiki',
    ...
    posts: [
      {
        ...
        image: '/images/blog/late-night-dessert-waikiki.jpeg',
        category: 'フードガイド',
        title: 'ワイキキ夜のスイーツ：21時までビンスとドーナツ',
        excerpt: 'ワイキキのベーカリーは夕方に閉まる店が多いなか、Kona Coffee Donutは毎日21時までビンス・モチドーナツ・マラサダ・缶ボバを提供。ビーチから徒歩5分。',
        readTime: 5,
      },
      {
        slug: 'what-is-ube-waikiki',
        image: '/images/blog/what-is-ube-waikiki.jpeg',
        category: 'フードガイド',
        title: 'ウベとは？味・タロとの違い・ワイキキで食べられる場所',
        excerpt: 'ウベはフィリピン原産の紫ヤムイモ。タロでもサツマイモでもなく、バニラとココナッツのようなナッツ系の甘さ。ワイキキのウベドーナツ・ビンス・ラテ。',
        readTime: 6,
      },
      {
        slug: 'mochi-donut-vs-regular-donut',
        image: '/images/blog/mochi-donut-vs-regular-donut.jpeg',
        category: '比較',
        title: 'モチドーナツと普通のドーナツの違い',
        excerpt: '米粉のもちもち vs 小麦のふわふわ。生地・食感・甘さ・鮮度・食べ方の違いを解説。ワイキキでモチドーナツとマラサダを食べ比べ。',
        readTime: 6,
      },
      {
        slug: 'coffee-near-waikiki-beach',
      ...
      },
      {
        ...
        image: '/images/blog/best-breakfast-waikiki.jpeg',
        category: 'フードガイド',
        title: 'ワイキキの朝ごはん：朝7時オープン、ドーナツ・むすび・コナコーヒー',
        excerpt: 'スパムむすび$2.95〜、作りたてドーナツとマラサダ、100%コナコーヒー。$10以下のハワイ朝食、ビーチから徒歩5分。',
        readTime: 5,
      },
      {
        slug: 'boba-waikiki',
        image: '/images/blog/boba-waikiki.jpeg',
        category: 'フードガイド',
        title: 'ワイキキでボバ（タピオカ）：缶入りミルクティー6種$8.95',
        excerpt: 'クラシック、黒糖、ウベ、コーヒー、タイティー、抹茶。密封缶でビーチへそのまま。',
        readTime: 4,
      },
      {
        slug: 'musubi-waikiki',
        image: '/images/blog/musubi-waikiki.jpeg',
        category: 'フードガイド',
        title: 'ワイキキのスパムむすび$2.95〜：毎日店内で手作り',
        excerpt: 'ハワイの定番を作りたてで。スパム、テリヤキ、エッグ、しそわかめ、シュリンプアボカドの5種。',
        readTime: 4,
      },
      {
        slug: 'shaved-ice-in-korean',
      ...
      },
      {
        ...
        excerpt: 'マラサダ、ポケ、プレートランチ、ガーリックシュリンプ、シェイブアイス、ビンス、モチドーナツ、100%コナコーヒー、アサイーボウル、韓国コーンドッグ。ビーチ徒歩圏の店つき。',
        readTime: 8,
      },
      {
        slug: 'korean-corn-dog-honolulu-viral',
        image: '/images/blog/korean-corn-dog-honolulu-viral.jpg',
        category: 'Kフード',
        title: 'ホノルルで韓国コーンドッグ：なぜバズったのか、どこで食べられるか',
        excerpt: '米粉の衣、伸びるモッツァレラ、砂糖がけ。TikTokで世界一撮影されたストリートフードの人気の理由と6種類、ワイキキで揚げたてが食べられる場所。',
        readTime: 6,
      },
      {
        slug: 'best-poke-waikiki',
        ...
        excerpt: '本物のハワイアンポケは魚カウンターで量り売り。ワイキキ・カパフルの店、注文の仕方、相場、食後のデザートまで。',
        readTime: 6,
      },
      {
        slug: 'bingsu-vs-shaved-ice-kakigori',
      ...
      },
      {
        ...
        image: '/images/blog/matcha-story-waikiki.jpeg',
        category: 'コーヒー',
        title: '抹茶の物語：日本の茶道からワイキキの一杯まで（2026）',
        excerpt: '抹茶の物語 — 禅寺と日本の茶道から始まる歴史、茶道用と製菓用の違い、その効能、そしてワイキキで点てたての一杯を飲める場所まで。',
        readTime: 8,
      },
      {
        slug: 'matcha-vs-hojicha-waikiki',
        image: '/images/blog/matcha-vs-hojicha-waikiki.jpeg',
        category: 'コーヒー',
        title: '抹茶とほうじ茶の違いとは？（2026）',
        excerpt: '抹茶とほうじ茶をわかりやすく比較 — 鮮やかで青々しい抹茶と、焙煎して低カフェインのほうじ茶。色・味・カフェインの違いと、ワイキキで両方を味わえる場所を紹介。',
        readTime: 8,
      },
      {
        slug: 'best-matcha-drinks-waikiki',
        image: '/images/blog/best-matcha-drinks-waikiki.jpeg',
        category: 'コーヒー',
        title: 'ワイキキで一番おいしい抹茶ドリンク：全フレーバー比較（2026）',
        excerpt: 'ワイキキで一番おいしい抹茶をランキングで。本格点てたて日本産抹茶、人気No.1のストロベリー抹茶、クラシック、トロピカル、ほうじ茶、アイスまで。',
        readTime: 6,
      },
      {
        slug: 'matcha-vs-coffee-waikiki',
        image: '/images/blog/matcha-vs-coffee-waikiki.jpeg',
        category: 'コーヒー',
        title: '抹茶 vs コーヒー：どっちを飲むべき？（2026）',
        excerpt: '万人の勝者はなし — 抹茶はL-テアニンで穏やかな約60〜70mg、コーヒーは力強い約95〜120mg。Kona Coffee Donut? なら両方試せます。',
        readTime: 8,
      },
      {
        slug: 'matcha-benefits-waikiki',
        image: '/images/blog/matcha-benefits-waikiki.jpeg',
        category: 'コーヒー',
        title: '抹茶の効能とカフェイン：抹茶は体にいい？（2026）',
        excerpt: '抹茶は体にいい？抹茶の効能を解説 — 抗酸化物質（EGCG）、集中を支えるL-テアニン、代謝や肌、そしてコーヒーと比べた抹茶のカフェイン量。',
        readTime: 6,
      },
      {
        slug: 'iced-matcha-latte-waikiki',
        image: '/images/blog/iced-matcha-latte-waikiki.jpeg',
        category: 'コーヒー',
        title: 'ワイキキのアイス抹茶ラテ：ビーチ日和の一杯（2026）',
        excerpt: 'ワイキキで美味しいアイス抹茶ラテを飲むなら。本物の石臼挽き抹茶（シロップではなく）、甘すぎず、ストロベリーやマンゴー、オーツ・アーモンド・ソイも。ワイキキビーチ近く。',
        readTime: 6,
      },
      {
        slug: 'hojicha-latte-waikiki',
    ...
    posts: [
      {
        ...
        image: '/images/blog/late-night-dessert-waikiki.jpeg',
        category: '푸드 가이드',
        title: '와이키키 야식 디저트: 밤 9시까지 빙수와 도넛',
        excerpt: '와이키키 베이커리 대부분은 저녁 6시면 닫습니다. Kona Coffee Donut은 매일 밤 9시까지 빙수·모찌도넛·말라사다·캔 보바를 판매. 해변에서 도보 5분.',
        readTime: 5,
      },
      {
        slug: 'what-is-ube-waikiki',
        image: '/images/blog/what-is-ube-waikiki.jpeg',
        category: '푸드 가이드',
        title: '우베란? 맛, 타로와의 차이, 와이키키에서 먹는 곳',
        excerpt: '우베는 필리핀 자색 참마. 타로도 고구마도 아닌, 바닐라·코코넛 같은 고소한 단맛. 와이키키 우베 모찌도넛·빙수·라떼 안내.',
        readTime: 6,
      },
      {
        slug: 'mochi-donut-vs-regular-donut',
        ...
        excerpt: '쌀가루의 쫀득함 vs 밀가루의 폭신함. 반죽·식감·당도·신선도·먹는 법 차이 정리. 와이키키에서 모찌도넛과 말라사다 비교 시식.',
        readTime: 6,
      },
      {
        slug: 'coffee-near-waikiki-beach',
      ...
      },
      {
        ...
        image: '/images/blog/best-breakfast-waikiki.jpeg',
        category: '푸드 가이드',
        title: '와이키키 아침식사: 아침 7시 오픈, 도넛·무스비·코나커피',
        excerpt: '스팸무스비 $2.95부터, 갓 만든 도넛과 말라사다, 100% 코나커피. $10 이하 하와이 아침, 비치 도보 5분.',
        readTime: 5,
      },
      {
        slug: 'boba-waikiki',
        image: '/images/blog/boba-waikiki.jpeg',
        category: '푸드 가이드',
        title: '와이키키 보바: 캔 밀크티 6종 $8.95',
        excerpt: '클래식, 흑당, 우베, 커피, 타이티, 말차. 밀봉 캔으로 비치까지 그대로.',
        readTime: 4,
      },
      {
        slug: 'musubi-waikiki',
        image: '/images/blog/musubi-waikiki.jpeg',
        category: '푸드 가이드',
        title: '와이키키 스팸무스비 $2.95부터: 매일 매장 직접 제조',
        excerpt: '하와이 국민 간식을 갓 만들어서. 스팸, 테리야키, 에그, 시소와카메, 쉬림프아보카도 5종.',
        readTime: 4,
      },
      {
        slug: 'shaved-ice-in-korean',
      ...
      },
      {
        ...
        excerpt: '말라사다, 포케, 플레이트 런치, 갈릭 쉬림프, 셰이브 아이스, 빙수, 모찌도넛, 100% 코나 커피, 아사이볼, 한국 핫도그 — 비치 도보 거리에서 먹을 수 있는 곳까지.',
        readTime: 8,
      },
      {
        slug: 'korean-corn-dog-honolulu-viral',
        image: '/images/blog/korean-corn-dog-honolulu-viral.jpg',
        category: 'K-푸드',
        title: '호놀룰루 한국 핫도그: 왜 바이럴이 됐고 어디서 먹을까',
        excerpt: '쌀가루 튀김옷, 늘어나는 모짜렐라, 설탕 솔솔. 틱톡에서 터진 이유와 6가지 스타일, 와이키키에서 갓 튀긴 핫도그를 먹는 곳.',
        readTime: 6,
      },
      {
        slug: 'best-poke-waikiki',
        ...
        excerpt: '진짜 하와이안 포케는 생선 카운터에서 무게로. 와이키키·카파훌루 맛집, 주문법, 가격대, 식후 디저트까지.',
        readTime: 6,
      },
      {
        slug: 'bingsu-vs-shaved-ice-kakigori',
      ...
      },
      {
        ...
        image: '/images/blog/matcha-story-waikiki.jpeg',
        category: '커피',
        title: '말차 이야기: 일본 다도에서 와이키키의 한 잔까지 (2026)',
        excerpt: '말차의 이야기 — 선 사찰과 일본 다도에서 시작된 역사, 의식용과 조리용의 차이, 그 효능, 그리고 와이키키에서 갓 저은 한 잔을 마실 수 있는 곳까지.',
        readTime: 8,
      },
      {
        slug: 'matcha-vs-hojicha-waikiki',
        image: '/images/blog/matcha-vs-hojicha-waikiki.jpeg',
        category: '커피',
        title: '말차 vs 호지차: 무엇이 다를까? (2026)',
        excerpt: '말차와 호지차를 명확하게 비교 — 선명하고 풀향 가득한 말차 vs 로스팅한 저카페인 호지차. 색·맛·카페인 차이와 와이키키에서 둘 다 맛보는 곳을 소개합니다.',
        readTime: 8,
      },
      {
        slug: 'best-matcha-drinks-waikiki',
        image: '/images/blog/best-matcha-drinks-waikiki.jpeg',
        category: '커피',
        title: '와이키키 최고의 말차 음료: 플레이버 랭킹 (2026)',
        excerpt: '와이키키 최고의 말차를 랭킹으로. 진짜 갓 격불한 일본 말차, 베스트셀러 딸기 말차부터 클래식·트로피컬·호지차·아이스까지.',
        readTime: 6,
      },
      {
        slug: 'matcha-vs-coffee-waikiki',
        image: '/images/blog/matcha-vs-coffee-waikiki.jpeg',
        category: '커피',
        title: '말차 vs 커피: 어떤 걸 마셔야 할까? (2026)',
        excerpt: '절대 승자는 없음 — 말차는 L-테아닌으로 차분한 약 60~70mg, 커피는 강한 약 95~120mg. Kona Coffee Donut? 에서 둘 다 맛보세요.',
        readTime: 8,
      },
      {
        slug: 'matcha-benefits-waikiki',
        image: '/images/blog/matcha-benefits-waikiki.jpeg',
        category: '커피',
        title: '말차의 효능과 카페인: 말차는 몸에 좋을까? (2026)',
        excerpt: '말차는 몸에 좋을까? 말차 효능 정리 — 항산화 물질(EGCG), 집중을 돕는 L-테아닌, 신진대사와 피부, 그리고 커피와 비교한 말차 카페인.',
        readTime: 6,
      },
      {
        slug: 'iced-matcha-latte-waikiki',
        image: '/images/blog/iced-matcha-latte-waikiki.jpeg',
        category: '커피',
        title: '와이키키 아이스 말차 라테: 해변의 완벽한 한 잔 (2026)',
        excerpt: '와이키키에서 최고의 아이스 말차 라테 마시는 곳. 진짜 맷돌로 간 말차(시럽 아님), 너무 달지 않고, 딸기·망고와 귀리·아몬드·두유 옵션까지. 와이키키 해변 근처.',
        readTime: 6,
      },
      {
        slug: 'hojicha-latte-waikiki',
    ...
    posts: [
      {
        ...
        image: '/images/blog/late-night-dessert-waikiki.jpeg',
        category: '美食指南',
        title: '威基基深夜甜品：刨冰和甜甜圈营业到晚上9点',
        excerpt: '威基基多数烘焙店傍晚就打烊。Kona Coffee Donut每天营业到晚上9点，供应刨冰、麻糬甜甜圈、马拉萨达和罐装奶茶，距海滩步行5分钟。',
        readTime: 5,
      },
      {
        slug: 'what-is-ube-waikiki',
        image: '/images/blog/what-is-ube-waikiki.jpeg',
        category: '美食指南',
        title: '什么是Ube紫山药？味道、与香芋的区别、威基基哪里吃',
        excerpt: 'Ube是菲律宾紫山药，不是香芋也不是紫薯，带香草椰子般的坚果甜香。威基基的紫山药麻糬甜甜圈、刨冰和拿铁。',
        readTime: 6,
      },
      {
        slug: 'mochi-donut-vs-regular-donut',
        image: '/images/blog/mochi-donut-vs-regular-donut.jpeg',
        category: '对比',
        title: '麻糬甜甜圈 vs 普通甜甜圈：到底哪里不同',
        excerpt: '米粉的Q弹 vs 面粉的松软。面团、口感、甜度、新鲜度和吃法的区别。在威基基一次尝遍麻糬甜甜圈和马拉萨达。',
        readTime: 6,
      },
      {
        slug: 'coffee-near-waikiki-beach',
      ...
      },
      {
        ...
        image: '/images/blog/best-breakfast-waikiki.jpeg',
        category: '美食指南',
        title: '威基基早餐：早上7点开门，甜甜圈·饭团·科纳咖啡',
        excerpt: '午餐肉饭团$2.95起、现做甜甜圈和马拉萨达、100%科纳咖啡。$10以内的夏威夷早餐，距海滩步行5分钟。',
        readTime: 5,
      },
      {
        slug: 'boba-waikiki',
        image: '/images/blog/boba-waikiki.jpeg',
        category: '美食指南',
        title: '威基基珍珠奶茶：罐装奶茶6种口味$8.95',
        excerpt: '经典、黑糖、紫薯、咖啡、泰式、抹茶。密封罐装，直接带去海滩。',
        readTime: 4,
      },
      {
        slug: 'musubi-waikiki',
        image: '/images/blog/musubi-waikiki.jpeg',
        category: '美食指南',
        title: '威基基午餐肉饭团$2.95起：每天现做',
        excerpt: '夏威夷国民小吃现做现卖：经典、照烧、鸡蛋、紫苏海带、虾仁牛油果5种。',
        readTime: 4,
      },
      {
        slug: 'shaved-ice-in-korean',
      ...
      },
      {
        ...
        excerpt: '马拉萨达、poke、餐盘午餐、蒜香虾、刨冰、雪冰、麻糬甜甜圈、100%科纳咖啡、巴西莓碗、韩式热狗——附海滩步行可达的店铺。',
        readTime: 8,
      },
      {
        slug: 'korean-corn-dog-honolulu-viral',
        ...
        excerpt: '米粉外皮、拉丝马苏里拉、撒糖粉。韩式热狗在TikTok爆红的原因、6种款式，以及威基基现炸热狗的地点。',
        readTime: 6,
      },
      {
        slug: 'best-poke-waikiki',
        ...
        excerpt: '真正的夏威夷poke在鱼档按磅卖。威基基和Kapahulu的店、怎么点、价格，以及饭后甜品去哪。',
        readTime: 6,
      },
      {
        slug: 'bingsu-vs-shaved-ice-kakigori',
      ...
      },
      {
        ...
        image: '/images/blog/matcha-story-waikiki.jpeg',
        category: '咖啡',
        title: '抹茶的故事：从日本茶道到你的威基基一杯（2026）',
        excerpt: '抹茶的完整故事 — 从禅寺与日本茶道而来的历史、仪式级与烘焙级的区别、它的益处，以及在威基基喝到一杯现搅抹茶的地方。',
        readTime: 8,
      },
      {
        slug: 'matcha-vs-hojicha-waikiki',
        image: '/images/blog/matcha-vs-hojicha-waikiki.jpeg',
        category: '咖啡',
        title: '抹茶 vs 焙茶：有什么区别？（2026）',
        excerpt: '清晰对比抹茶与焙茶 — 鲜绿草香的抹茶 vs 烘焙低咖啡因的焙茶。比较颜色、风味与咖啡因，并找到在威基基同时尝到两款的地方。',
        readTime: 8,
      },
      {
        slug: 'best-matcha-drinks-waikiki',
        image: '/images/blog/best-matcha-drinks-waikiki.jpeg',
        category: '咖啡',
        title: '威基基最好喝的抹茶饮品：口味排行（2026）',
        excerpt: '威基基最好喝的抹茶排行榜。正宗现打日本抹茶，招牌草莓抹茶领衔，还有经典、热带、焙茶与冰饮选择。',
        readTime: 6,
      },
      {
        slug: 'matcha-vs-coffee-waikiki',
        image: '/images/blog/matcha-vs-coffee-waikiki.jpeg',
        category: '咖啡',
        title: '抹茶 vs 咖啡：该喝哪一个？（2026）',
        excerpt: '没有绝对赢家 — 抹茶靠L-茶氨酸带来平稳的约60～70mg，咖啡则是更强的约95～120mg；在 Kona Coffee Donut? 两者都能试。',
        readTime: 8,
      },
      {
        slug: 'matcha-benefits-waikiki',
        image: '/images/blog/matcha-benefits-waikiki.jpeg',
        category: '咖啡',
        title: '抹茶的功效与咖啡因：抹茶对身体好吗？（2026）',
        excerpt: '抹茶对身体好吗？抹茶功效全解析 — 抗氧化物质（EGCG）、助你专注的L-茶氨酸、新陈代谢与肌肤，以及抹茶与咖啡的咖啡因对比。',
        readTime: 6,
      },
      {
        slug: 'iced-matcha-latte-waikiki',
        image: '/images/blog/iced-matcha-latte-waikiki.jpeg',
        category: '咖啡',
        title: '威基基冰抹茶拿铁：完美的海滩日饮品（2026）',
        excerpt: '在威基基喝到最好的冰抹茶拿铁 — 真正石磨抹茶（而非糖浆）、不太甜，还有草莓、芒果与燕麦奶/杏仁奶/豆奶可选，就在威基基海滩附近。',
        readTime: 6,
      },
      {
        slug: 'hojicha-latte-waikiki',
    ...
    posts: [
      {
        ...
        title: 'Postres de noche en Waikiki: bingsu y donas hasta las 9 PM',
        excerpt: 'La mayoría de panaderías de Waikiki cierran a las 6 PM. Kona Coffee Donut sirve bingsu, mochi donuts, malasadas y boba en lata hasta las 9 PM, a 5 minutos de la playa.',
        readTime: 5,
      },
      {
        slug: 'what-is-ube-waikiki',
        image: '/images/blog/what-is-ube-waikiki.jpeg',
        category: 'Guía Gastronómica',
        title: '¿Qué es el ube? Sabor, ube vs taro y dónde probarlo en Waikiki',
        excerpt: 'El ube es un ñame morado filipino — ni taro ni camote — con sabor a vainilla y coco. Mochi donuts, bingsu y lattes de ube en Waikiki.',
        readTime: 6,
      },
      {
        slug: 'mochi-donut-vs-regular-donut',
        ...
        title: 'Mochi donut vs dona normal: en qué se diferencian',
        excerpt: 'Harina de arroz chiclosa vs trigo esponjoso: masa, textura, dulzor, frescura y cómo comerla. Prueba ambas (mochi donut y malasada) en Waikiki.',
        readTime: 6,
      },
      {
        slug: 'coffee-near-waikiki-beach',
      ...
      },
      {
        ...
        image: '/images/blog/best-breakfast-waikiki.jpeg',
        category: 'Guía Gastronómica',
        title: 'Desayuno en Waikiki desde las 7 AM: Donuts, Musubi y Café Kona',
        excerpt: 'Spam musubi desde $2.95, donuts frescos y café 100% Kona — desayuno hawaiano por menos de $10.',
        readTime: 5,
      },
      {
        slug: 'boba-waikiki',
        image: '/images/blog/boba-waikiki.jpeg',
        category: 'Guía Gastronómica',
        title: 'Boba en Waikiki: Milk Tea en Lata, 6 Sabores a $8.95',
        excerpt: 'Clásico, azúcar morena, ube, café, té tailandés y matcha. Lata sellada para llevar a la playa.',
        readTime: 4,
      },
      {
        slug: 'musubi-waikiki',
        image: '/images/blog/musubi-waikiki.jpeg',
        category: 'Guía Gastronómica',
        title: 'Spam Musubi en Waikiki desde $2.95: Fresco a Diario',
        excerpt: 'El snack favorito de Hawái: spam clásico, teriyaki, huevo, shiso wakame y camarón-aguacate.',
        readTime: 4,
      },
      {
        slug: 'shaved-ice-in-korean',
      ...
      },
      {
        ...
        excerpt: 'Malasadas, poke, plate lunch, camarones al ajo, shave ice, bingsu, mochi donuts, café 100% Kona, açaí y corn dogs coreanos — y dónde comerlos cerca de la playa.',
        readTime: 8,
      },
      {
        slug: 'korean-corn-dog-honolulu-viral',
        image: '/images/blog/korean-corn-dog-honolulu-viral.jpg',
        category: 'K-Food',
        title: 'Korean Corn Dogs en Honolulu: por qué son virales y dónde comerlos',
        excerpt: 'Masa de arroz, mozzarella que se estira, azúcar encima. Por qué conquistó TikTok, los 6 estilos y dónde comerlo recién frito en Waikiki.',
        readTime: 6,
      },
      {
        slug: 'best-poke-waikiki',
        ...
        excerpt: 'El poke hawaiano de verdad se vende por libra en pescaderías. Dónde comprarlo, cómo pedirlo, precios y dónde ir de postre.',
        readTime: 6,
      },
      {
        slug: 'bingsu-vs-shaved-ice-kakigori',
      ...
      },
      {
        ...
        image: '/images/blog/matcha-story-waikiki.jpeg',
        category: 'Café',
        title: 'La Historia del Matcha: De la Ceremonia del Té a Tu Taza (2026)',
        excerpt: 'La historia del matcha — su recorrido desde los templos zen y la ceremonia del té japonesa, grado ceremonial vs culinario, sus beneficios y dónde tomar una taza recién batida en Waikiki.',
        readTime: 8,
      },
      {
        slug: 'matcha-vs-hojicha-waikiki',
        image: '/images/blog/matcha-vs-hojicha-waikiki.jpeg',
        category: 'Café',
        title: 'Matcha vs Hojicha: ¿Cuál es la Diferencia? (2026)',
        excerpt: 'El matcha vs el hojicha, explicado: matcha vibrante y herbáceo frente al hojicha tostado y bajo en cafeína. Compara color, sabor y cafeína, y dónde probar ambos en Waikiki.',
        readTime: 8,
      },
      {
        slug: 'best-matcha-drinks-waikiki',
        image: '/images/blog/best-matcha-drinks-waikiki.jpeg',
        category: 'Café',
        title: 'Las Mejores Bebidas de Matcha en Waikiki: Sabores Clasificados (2026)',
        excerpt: 'El mejor matcha de Waikiki, clasificado: matcha japonés batido al momento, encabezado por nuestro Strawberry Matcha más vendido, además de clásico, tropical, hojicha y opciones con hielo.',
        readTime: 6,
      },
      {
        slug: 'matcha-vs-coffee-waikiki',
        image: '/images/blog/matcha-vs-coffee-waikiki.jpeg',
        category: 'Café',
        title: 'Matcha vs Café: ¿Cuál Deberías Beber? (2026)',
        excerpt: 'No hay un ganador universal: el matcha da un impulso tranquilo (~60–70mg) con L-teanina; el café, uno más fuerte (~95–120mg). En Kona Coffee Donut? puedes probar ambos.',
        readTime: 8,
      },
      {
        slug: 'matcha-benefits-waikiki',
        image: '/images/blog/matcha-benefits-waikiki.jpeg',
        category: 'Café',
        title: 'Beneficios del Matcha y Cafeína: ¿Es Bueno para Ti? (2026)',
        excerpt: '¿El matcha es bueno para ti? Beneficios del matcha: antioxidantes (EGCG), L-teanina para energía calmada y enfocada, metabolismo y piel, y cuánta cafeína tiene frente al café.',
        readTime: 6,
      },
      {
        slug: 'iced-matcha-latte-waikiki',
        image: '/images/blog/iced-matcha-latte-waikiki.jpeg',
        category: 'Café',
        title: 'Iced Matcha Latte en Waikiki: La Bebida Perfecta de Playa (2026)',
        excerpt: 'Un refrescante iced matcha latte de matcha real molido en piedra en Waikiki — no muy dulce, con opciones de fresa y leches vegetales, a minutos de la playa.',
        readTime: 6,
      },
      {
        slug: 'hojicha-latte-waikiki',
