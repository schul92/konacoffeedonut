...
export async function generateMetadata({
  ...
  const metadata: Record<string, { title: string; description: string }> = {
    en: {
      title: "Acai Bowl Waikiki | Best Superfood Bowls Hawaii | Kona Coffee Donut",
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'en': `${siteUrl}/en/menu/acai-bowl`,
        'ja': `${siteUrl}/ja/menu/acai-bowl`,
        'ko': `${siteUrl}/ko/menu/acai-bowl`,
        'zh': `${siteUrl}/zh/menu/acai-bowl`,
      },
    },
  };
}
