  ...
  en: {
    ...
    comparison: {
      ...
      rows: [
        ...
        ['Price Range', '$5 - $10', '$15 - $20', '$11.25 / 3pc', '$2 - $4', '$10 - $14'],
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'For budget-friendly desserts near Waikiki, Leonard\'s Bakery offers malasadas starting at around $2 each. Uncle Tetsu\'s sells an entire Japanese cheesecake for about $10 at Ala Moana Center. Mochi donuts at Kona Coffee Donut come in boxes from $11.25 for 3 (about $3.75 each). For the best value, get a half-dozen malasadas from Leonard\'s to share, or split a bingsu between two people.',
        },
      ],
    },
    cta: {
      ...
      text: 'Mochi donuts, malasadas, bingsu, and acai bowls — all paired with premium Honolulu Coffee. Steps from Waikiki Beach, open daily 7 AM to 9 PM.',
  ...
  ja: {
    ...
    shops: [
      {
        ...
        priceRange: '$$',
        knownFor: 'モチドーナツ、マラサダ、ビンス、アサイーボウル、ホノルルコーヒー',
        description: 'デザートを一箇所で全部楽しみたいなら、ここが最適です。コナコーヒードーナツはワイキキ最新のカフェで、カラカウア通りで唯一、もちもちのMOCHILANDモチドーナツ、揚げたてマラサダ、韓国式ビンス、トロピカルアサイーボウルのすべてが一つの屋根の下で楽しめるお店です。モチドーナツはプレミアム米粉を使用したシグネチャーの八つ玉形状で、外はサクサク、中はもちもち。紫芋、抹茶、黒ごま、マンゴー、季節限定など12種類以上のフレーバーが楽しめます。マラサダは毎朝黄金色にふわふわに揚げられ、ハウピアクリーム、リリコイカスタード、シナモンシュガーなどのバリエーションも。ビンスは細かく削ったミルク氷の山にフレッシュフルーツ、もち、あずきをトッピング — 暑いワイキキの午後のシェアにぴったり。すべてのデザートはホノルルコーヒーのプレミアムホノルルコーヒーとペアリングして、究極の体験を。ワイキキビーチからすぐの場所にあり、ビーチ帰りやディナー後のデザートスポットに最適です。',
    ...
    comparison: {
      ...
      rows: [
        ...
        ['価格帯', '$5 - $10', '$15 - $20', '$11.25 / 3個', '$2 - $4', '$10 - $14'],
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: 'ワイキキで一番安いデザートは？',
          a: '予算重視のデザートなら、レナーズベーカリーのマラサダが1個約$2から。アンクルテツのチーズケーキはアラモアナセンターでホール約$10。コナコーヒードーナツのモチドーナツはボックス販売で3個$11.25から（約$3.75/個）。お得に楽しむなら、レナーズのマラサダをハーフダース購入するか、ビンスを2人でシェアするのがおすすめ。',
        },
      ],
    },
    cta: {
      ...
      text: 'モチドーナツ、マラサダ、ビンス、アサイーボウル — すべてプレミアムホノルルコーヒーと共に。ワイキキビーチからすぐ、毎日朝7時〜夜9時営業。',
  ...
  ko: {
    ...
    comparison: {
      ...
      rows: [
        ...
        ['가격대', '$5 - $10', '$15 - $20', '$11.25 / 3개', '$2 - $4', '$10 - $14'],
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: '가성비 디저트로는 레너즈 베이커리 말라사다가 개당 약 $2부터. 엉클 테츠 치즈케이크는 알라모아나 센터에서 홀 약 $10. 코나커피도넛 모찌 도넛은 박스 단위로 3개 $11.25부터(개당 약 $3.75). 가장 경제적으로 즐기려면 레너즈 말라사다 반 다스를 사거나 빙수를 2인이서 나눠 먹는 것을 추천.',
        },
      ],
    },
    cta: {
      ...
      text: '모찌 도넛, 말라사다, 빙수, 아사이 볼 — 모두 프리미엄 호놀룰루 커피와 함께. 와이키키 비치에서 가까운 곳, 매일 오전 7시 ~ 오후 9시.',
      menuButton: '전체 메뉴 보기',
  ...
  zh: {
    ...
    shops: [
      {
        ...
        priceRange: '$$',
        knownFor: '麻糬甜甜圈、马拉萨达、冰沙、巴西莓碗配檀香山咖啡',
        description: '如果您想在一个地方品尝所有类型的甜点，这里就是最佳选择。科纳咖啡甜甜圈是威基基最新的咖啡馆，也是卡拉卡瓦大道上唯一可以一站式品尝MOCHILAND麻糬甜甜圈、新鲜马拉萨达、韩式冰沙和热带巴西莓碗的地方。麻糬甜甜圈采用优质米粉制成的招牌八球形状，外酥里糯。口味轮换12种以上，包括紫薯、抹茶、黑芝麻、芒果和季节限定。马拉萨达每天早晨炸至金黄蓬松，有椰子奶油、百香果蛋奶和肉桂糖等多种口味。冰沙是一座细腻刨冰山，顶部放满新鲜水果、麻糬和红豆——非常适合在炎热的威基基午后分享。搭配来自檀香山咖啡的优质檀香山咖啡，享受完整体验。咖啡馆距离威基基海滩仅几步之遥，是海滩归来或晚餐后的理想甜点目的地。',
    ...
    comparison: {
      ...
      rows: [
        ...
        ['价格范围', '$5 - $10', '$15 - $20', '$11.25 / 3个', '$2 - $4', '$10 - $14'],
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: '威基基最便宜的甜点选择是什么？',
          a: '预算友好的甜点首选Leonard\'s Bakery的马拉萨达，约$2一个起。Uncle Tetsu整个芝士蛋糕约$10。科纳咖啡甜甜圈的麻糬甜甜圈盒装销售，3个$11.25起（约$3.75/个）。最划算的方式：买半打Leonard\'s马拉萨达分享，或两人分一份冰沙。',
        },
      ],
    },
    cta: {
      ...
      text: '麻糬甜甜圈、马拉萨达、冰沙、巴西莓碗——全部搭配优质檀香山咖啡。距威基基海滩几步之遥，每天上午7点至晚上9点营业。',
      menuButton: '查看完整菜单',
