...
const content: Record<Locale, BlogContent> = {
  en: {
    ...
    intro:
      "Waikiki has a reputation for expensive resort food, but locals and savvy visitors know there's a whole budget food scene tucked between the hotels. Plate lunches for $10, mochi donuts about $3.75 each, malasadas from $3.95, real Kona coffee for $7 — all walking distance from Waikiki Beach. This guide is the cheap eats playbook: where to go, what to order, how much it costs, and how to maximize value without sacrificing the Hawaii experience.",
    visitCTA: {
      headline: 'Cheap, Authentic, on Kalākaua',
      body:
        "Kona Coffee Donut is one of Waikiki's best budget food stops — mochi donuts from $11.25 for 3 (about $3.75 each), malasadas from $3.95, real Honolulu Coffee, plus bingsu and smoothies. Open 7 AM to 9 PM daily.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Kona Coffee Donut (2142 Kalākaua Ave) — Mochi donuts from $11.25 for 3, malasadas from $3.95, Honolulu Coffee, bingsu, smoothies. Open 7 AM–9 PM.",
        ...
        pullout: {
          ...
          body: "At Kona Coffee Donut: a malasada + Honolulu Coffee iced coffee runs about $11. Comparable mainland coffee shops charge $12+ for the same with worse coffee.",
        },
      },
      {
        h2: 'Budget Breakfast Ideas',
        body:
          "Hotel buffets in Waikiki are $35–$50 per person. You can eat just as well for about $11:",
        bullets: [
          'Kona Coffee Donut: malasada + coffee = ~$11',
      ...
      },
      {
        ...
        bullets: [
          'Mochi donuts at Kona Coffee Donut: from $11.25 for 3 (~$3.75 each)',
    ...
    faq: [
      { q: 'What is the cheapest place to eat in Waikiki?', a: 'Malasadas at Kona Coffee Donut start at $3.95, and mochi donuts come in boxes from $11.25 for 3 (about $3.75 each). Plate lunches at Rainbow Drive-In and Aloha Mixed Plate run $10–$14. ABC Stores have musubi and sandwiches for $5–$10.' },
      ...
      { q: 'Is Kona coffee expensive in Waikiki?', a: 'Real Honolulu Coffee is $6–$7 per cup at authentic spots like Kona Coffee Donut. Avoid "Kona blend" labels — those contain as little as 10% real Kona.' },
      { q: 'What\'s the best cheap breakfast in Waikiki?', a: 'A malasada + Honolulu Coffee at Kona Coffee Donut runs ~$11 total. Comparable to mainland coffee shop pricing but with better coffee and Hawaiian flavors.' },
    ],
    finalCTA: {
  ...
  ja: {
    ...
    visitCTA: { headline: 'カラカウア通りで安くて本物', body: 'コナコーヒードーナツはモチドーナツ3個$11.25〜（約$3.75/個）、マラサダ$3.95〜、ホノルルコーヒー。毎日7時〜21時。', menuLabel: 'メニューを見る', directionsLabel: '行き方を確認' },
    sections: [
      ...
      { h2: '朝食アイデア', body: 'ホテルバッフェ$35-50の代わりに約$11で。', bullets: ['コナコーヒードーナツ：マラサダ+コーヒー約$11', '丸亀：うどん+天ぷら$10', 'ABCストア：おむすび+コーヒー$6'] },
      { h2: 'ランチアイデア', body: 'プレートランチがハワイの定番。', bullets: ['ロコモコ$12', 'カルアポーク$14'] },
      { h2: 'デザートアイデア', body: 'リゾート価格でない本格スイーツ。', bullets: ['モチドーナツ約$3.75/個（3個$11.25〜）', 'マラサダ$3.95〜（レナーズは$2）', 'ビンス（2人前）$14-18'] },
      { h2: '節約のコツ', body: '内陸に2-3ブロック歩くだけで価格が下がります。' },
    ],
    faq: [
      { q: 'ワイキキで一番安いお店は？', a: 'コナコーヒードーナツはマラサダ$3.95〜、モチドーナツ3個$11.25〜（約$3.75/個）。プレートランチ$10-14。' },
  ...
  ko: {
    ...
    visitCTA: { headline: '칼라카우아의 가성비 맛집', body: '코나커피도넛 모치도넛 3개 $11.25(개당 약 $3.75), 말라사다 $3.95부터, 호놀룰루 커피. 매일 7시–21시.', menuLabel: '메뉴 보기', directionsLabel: '길찾기' },
    sections: [
      ...
      { h2: '아침 아이디어', body: '호텔 뷔페 $35-50 대신 약 $11로.', bullets: ['코나커피도넛 약 $11', '마루카메 $10'] },
      { h2: '점심 아이디어', body: '하와이 정통 플레이트 런치.', bullets: ['로코모코 $12', '칼루아 포크 $14'] },
      { h2: '디저트 아이디어', body: '리조트 가격이 아닌 본격 디저트.', bullets: ['모치도넛 개당 약 $3.75 (3개 $11.25)', '말라사다 $3.95부터 (레너즈 $2)', '빙수(2인분) $14-18'] },
      { h2: '추가 절약 팁', body: '내륙으로 2-3블록만 가도 가격이 떨어집니다.' },
    ],
    faq: [
      { q: '와이키키 가장 저렴한 곳?', a: '코나커피도넛 말라사다 $3.95부터, 모치도넛 3개 $11.25(개당 약 $3.75).' },
      { q: '$15 이하 가능?', a: '네, 쉽게.' },
      { q: '하루 예산은?', a: '$30-45.' },
  ...
  zh: {
    ...
    visitCTA: { headline: '卡拉考阿大道的平价美食', body: 'Kona Coffee Donut 麻糬甜甜圈3个$11.25（约$3.75/个）、玛拉萨达$3.95起、檀香山咖啡。每天7点–21点。', menuLabel: '查看菜单', directionsLabel: '获取路线' },
    sections: [
      ...
      { h2: '早餐选择', body: '酒店自助$35-50的替代方案：约$11。', bullets: ['Kona Coffee Donut 约$11', 'Marukame $10'] },
      { h2: '午餐选择', body: '夏威夷传统便当。', bullets: ['Loco moco $12', 'Kalua pork $14'] },
      { h2: '甜品零食', body: '非度假村价格的正宗甜品。', bullets: ['麻糬甜甜圈约$3.75/个（3个$11.25）', '玛拉萨达$3.95起（Leonard\'s $2）', '雪冰(双人份) $14-18'] },
      { h2: '更省钱的技巧', body: '从海滨往内陆走2-3个街区，价格明显下降。' },
    ],
    faq: [
      { q: '威基基最便宜的餐厅？', a: 'Kona Coffee Donut 玛拉萨达$3.95起、麻糬甜甜圈3个$11.25（约$3.75/个）。' },
      { q: '$15以下能吃饱吗？', a: '可以，很容易。' },
      { q: '每天预算多少？', a: '$30-45足够。' },
  ...
  es: {
    ...
    visitCTA: { headline: 'Comida Real y Económica en Kalākaua', body: 'Kona Coffee Donut: mochi donuts desde $11.25 por 3 (~$3.75 c/u), malasadas desde $3.95, café Kona auténtico. 7 AM a 9 PM.', menuLabel: 'Ver Menú', directionsLabel: 'Cómo llegar' },
    sections: [
    ...
    faq: [
      { q: '¿Lugar más barato?', a: 'En Kona Coffee Donut: malasadas desde $3.95, mochi donuts ~$3.75 c/u (caja de 3 por $11.25).' },
