      ...
      },
      {
        ...
        hasMenuItem: [
          ...
          },
          {
            ...
            offers: { '@type': 'Offer', priceCurrency: 'USD', price: '6.35', availability: 'https://schema.org/InStock' },
          },
          {
            '@type': 'MenuItem',
            name: 'Kona Cold Brew',
            description: '100% Kona coffee cold-brewed and served over ice.',
            offers: { '@type': 'Offer', priceCurrency: 'USD', price: '6.95', availability: 'https://schema.org/InStock' },
          },
        ],
      },
      {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: {
          ...
          offers: { '@type': 'Offer', priceCurrency: 'USD', price: '3.75', availability: 'https://schema.org/InStock', url: `https://www.konacoffeedonut.com/${locale}/menu` },
        },
      },
      {
        '@type': 'ListItem',
        ...
        item: {
          ...
          offers: { '@type': 'Offer', priceCurrency: 'USD', price: '3.95', availability: 'https://schema.org/InStock', url: `https://www.konacoffeedonut.com/${locale}/menu` },
        },
      },
      {
        '@type': 'ListItem',
