...
const faqData: Record<string, Array<{ q: string; a: string }>> = {
  en: [
    { q: "What makes Kona Coffee special?", a: "We serve Honolulu Coffee's premium Honolulu Coffee, grown on the slopes of Mauna Loa in Hawaii. Known for smooth, rich flavor with low acidity — one of the most sought-after coffees in the world." },
  ...
  ko: [
    { q: "코나 커피가 특별한 이유는?", a: "저희는 호놀룰루 커피의 프리미엄 호놀룰루 커피를 제공합니다. 하와이 마우나 로아 산 경사면에서 재배되며 부드럽고 풍부한 맛과 낮은 산도로 유명합니다." },
  ...
  ja: [
    { q: "コナコーヒーの特別な点は？", a: "ホノルルコーヒーのプレミアムホノルルコーヒーを提供。ハワイのマウナロア山の斜面で栽培され、滑らかで豊かな風味と低い酸味で知られています。" },
