...
export default function Instagram() {
  ...
  const accounts = [
    ...
    },
    {
      ...
      logo: '/icons/mochi_land_circle.png',
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {accounts.map((account, index) => (
              ...
              >
                {/* Gradient Background */}
                <div className={`absolute inset-0 bg-gradient-to-br ${account.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300`} />
                ...
                <div className="relative p-8 md:p-10">
                  ...
                  <div className="flex justify-center">
                    <div className={`inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r ${account.color} text-white font-semibold shadow-md group-hover:shadow-xl transition-all duration-300`}>
                ...
                {/* Hover Effect Border */}
                <div className={`absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-current bg-gradient-to-r ${account.color} bg-clip-border opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none`} style={{ WebkitMaskComposite: 'xor', maskComposite: 'exclude' }} />
              </a>
            ))}
          </div>
        </div>
