...
const content: Record<Locale, BlogContent> = {
  en: {
    hero: {
      ...
      subtitle: 'The simple Italian dessert that turns 100% Kona coffee into something magical.',
      date: 'Updated May 2026',
      readTime: '4 min read',
      badge: 'Coffee Dessert',
    },
    intro:
      "Affogato is the kind of dessert that sounds too simple to be impressive: a scoop of vanilla bean ice cream, drowned in a shot of fresh hot espresso, eaten immediately while the espresso melts the cream. The simplicity is the point. When the espresso is exceptional — and at Kona Coffee Donut, ours is 100% Kona — the affogato becomes one of the best coffee desserts you can order. Here's what makes a great affogato, why Kona coffee elevates it, and where to try it on Kalākaua Avenue.",
    visitCTA: {
      headline: 'Kona Affogato — A Waikiki Coffee Dessert Worth Walking For',
      body:
        "Made with 100% Kona espresso, premium vanilla bean ice cream, and a small Italian-style ceramic glass. Eaten while still hot meeting cold. A perfect afternoon or after-dinner stop. Open daily 7 AM to 9 PM.",
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Two scoops of vanilla bean ice cream go into a small Italian-style glass. We pull a fresh single shot of 100% Kona espresso and pour it over at the table just before serving. You eat it immediately with a small spoon. Add-ons available: an extra espresso shot for double intensity, a drizzle of caramel or chocolate, or a side of mochi donut to dip.",
      },
      {
    ...
    faq: [
      ...
      { q: 'Where can I get affogato in Waikiki?', a: 'Kona Coffee Donut at 2142 Kalākaua Ave serves Kona affogato — vanilla bean ice cream with a fresh shot of 100% Kona espresso. Walking distance from Waikiki Beach. Open 7 AM to 9 PM.' },
      { q: 'How much does affogato cost?', a: 'Kona affogato pricing is available in-store. It\'s a premium dessert priced fairly for the quality of the 100% Kona espresso and vanilla bean ice cream used.' },
      ...
      { q: 'What makes Kona affogato special?', a: '100% Kona coffee has a smooth body, low acidity, and notes of brown sugar and chocolate. It pairs exceptionally well with vanilla bean ice cream — balanced, not bitter, with a clean finish.' },
    ...
    finalCTA: {
      ...
      body: 'Two scoops of vanilla bean ice cream, one shot of 100% Kona espresso, eaten immediately. The simplest perfect dessert in Waikiki.',
      visitLabel: 'Visit Us Today',
      callLabel: 'Call (808) 304-1808',
    },
  },
  ja: {
    hero: { title: 'ワイキキで楽しむコナアフォガート', subtitle: '100%コナコーヒーが魔法に変わるシンプルなイタリアンデザート。', date: '2026年5月更新', readTime: '読了4分', badge: 'コーヒーデザート' },
    intro: 'アフォガートはバニラアイスに熱いエスプレッソをかけて即食べる、シンプルなのに最高のコーヒーデザート。100%コナエスプレッソで作ると別格の味わいに。',
    visitCTA: { headline: 'カラカウア通りで本格コナアフォガート', body: '100%コナエスプレッソとプレミアムバニラビーンアイス。アツアツとひんやりが一度に楽しめる至福のデザート。毎日朝7時〜夜9時。', menuLabel: 'コーヒーメニュー', directionsLabel: '行き方を確認' },
    sections: [
      ...
      { h2: '当店のアフォガート', body: 'バニラビーンアイス2スクープ + 100%コナのフレッシュエスプレッソ + 本格イタリアンスタイルグラス。' },
      { h2: 'いつ食べる？', body: '午後のカフェイン補給、ディナー後のデザート、デートにも最適。ハワイの暑い気候にぴったり。' },
    ],
    faq: [
      { q: 'アフォガートとは？', a: 'バニラアイスに熱いエスプレッソをかけたイタリアン伝統デザート。' },
      { q: 'ワイキキでアフォガートは？', a: 'コナコーヒードーナツ（カラカウア通り 2142）で100%コナアフォガート提供。' },
      { q: 'コーヒー？デザート？', a: '両方。エスプレッソショット入りなのでカフェインもあり。' },
      { q: '何が特別？', a: '100%コナのスムースな味とバニラの相性が抜群。' },
    ],
    finalCTA: { headline: '今日コナアフォガートを', body: 'カラカウア通り 2142、ワイキキ中心部。', visitLabel: '今日来店', callLabel: '電話 (808) 304-1808' },
  },
  ko: {
    hero: { title: '와이키키 코나 아포가토', subtitle: '100% 코나커피를 마법처럼 만드는 단순한 이탈리아 디저트.', date: '2026년 5월', readTime: '4분 분량', badge: '커피 디저트' },
    intro: '아포가토는 바닐라 아이스크림에 뜨거운 에스프레소를 부어 바로 먹는 단순하지만 완벽한 디저트. 100% 코나로 만들면 차원이 다릅니다.',
    visitCTA: { headline: '칼라카우아 거리의 코나 아포가토', body: '100% 코나 에스프레소와 프리미엄 바닐라빈 아이스크림. 뜨거움과 차가움의 만남. 매일 7시–21시.', menuLabel: '커피 메뉴', directionsLabel: '길찾기' },
    sections: [
      ...
      { h2: '저희 아포가토', body: '바닐라빈 아이스 2스쿱 + 100% 코나 에스프레소 + 이탈리안 스타일 글래스.' },
      { h2: '언제 먹나요?', body: '오후 카페인 보충, 디저트, 데이트, 비치데이 등 어떤 순간에도.' },
    ],
    faq: [
      { q: '아포가토란?', a: '바닐라 아이스에 뜨거운 에스프레소를 부은 이탈리안 디저트.' },
      { q: '와이키키 어디서?', a: '코나커피도넛(2142 칼라카우아)에서 100% 코나 아포가토 제공.' },
      { q: '커피인가요 디저트인가요?', a: '둘 다. 에스프레소 샷이 들어 카페인도 있음.' },
      { q: '왜 특별한가요?', a: '100% 코나의 부드러움이 바닐라와 환상의 조합.' },
    ],
    finalCTA: { headline: '오늘 코나 아포가토를', body: '와이키키 중심부 2142 칼라카우아.', visitLabel: '오늘 방문', callLabel: '전화 (808) 304-1808' },
  },
  zh: {
    hero: { title: '威基基的科纳阿芙佳朵', subtitle: '让100%科纳咖啡变神奇的简单意式甜品。', date: '2026年5月', readTime: '4分钟', badge: '咖啡甜品' },
    intro: '阿芙佳朵是把热浓缩咖啡倒在香草冰淇淋上立即享用的简单完美甜品。用100% 科纳制作，味道升级。',
    visitCTA: { headline: '卡拉考阿大道的科纳阿芙佳朵', body: '100% 科纳浓缩咖啡 + 顶级香草豆冰淇淋。冷热交融的瞬间美味。每天7点–21点。', menuLabel: '咖啡菜单', directionsLabel: '获取路线' },
    sections: [
      ...
      { h2: '我们的阿芙佳朵', body: '香草豆冰淇淋两球 + 100%科纳浓缩 + 意式玻璃杯。' },
    ...
    faq: [
      ...
      { q: '科纳的特别之处？', a: '100%科纳顺滑低酸，与香草完美搭配。' },
    ],
    finalCTA: { headline: '今天就试试科纳阿芙佳朵', body: '威基基中心 2142 卡拉考阿。', visitLabel: '立即到店', callLabel: '致电 (808) 304-1808' },
  },
  es: {
    hero: { title: 'Affogato Kona en Waikiki', subtitle: 'El postre italiano simple que convierte el café Kona 100% en magia.', date: 'Mayo 2026', readTime: '4 min', badge: 'Postre de Café' },
    intro: 'Affogato — helado de vainilla "ahogado" en espresso caliente, comido al instante. Con espresso 100% Kona, se convierte en uno de los mejores postres de café que existen.',
    visitCTA: { headline: 'Affogato Kona en Kalākaua', body: 'Espresso 100% Kona y helado de vainilla premium. Caliente sobre frío. Abierto 7 AM a 9 PM.', menuLabel: 'Ver Menú', directionsLabel: 'Cómo llegar' },
    sections: [
      ...
      { h2: 'Cómo lo Hacemos', body: 'Dos bolas de helado de vainilla bourbon + shot fresco de espresso 100% Kona + vaso italiano.' },
