            ...
            >
              ...
              <article className="space-y-4 text-amber-900/80 text-base md:text-lg leading-relaxed">
                {locale === 'ja' ? (
                  ...
                  <>
                    <p><strong>Kona Coffee Donut</strong> is a Hawaiian café and bakery located at <span itemProp="address">2142 Kalakaua Ave, Honolulu, HI 96815</span> in Waikiki. <strong>Grand opening early March 2026</strong>. Prime location just <strong>5 minutes walking distance (400 meters)</strong> from Waikiki Beach.</p>
