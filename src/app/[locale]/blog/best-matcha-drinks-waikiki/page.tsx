...
const content = {
      ...
      items: [
        {
          ...
          answer: 'Our most popular matcha is the Strawberry Matcha ($11.95) — a creamy, sweet-tart layer of strawberry over freshly whisked matcha and milk. It\'s the crowd favorite and the one we recommend ordering first. If you want the pure taste of matcha, the Classic Matcha Latte ($9.95) is the best place to start.',
        },
        {
          question: 'Do you have strawberry matcha in Waikiki?',
          answer: 'Yes. Strawberry Matcha ($11.95) is our bestselling matcha drink, made with real whisked Japanese matcha, milk, and a sweet layer of strawberry. You\'ll find it at Kona Coffee Donut? on Kalākaua Ave, about a 5-minute walk from Waikiki Beach — hot or iced.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Most of our matcha lattes are $9.95 (Classic, Mango, Coconut, Guava, Banana, and Lilikoi Matcha). The Strawberry Matcha and Azuki Red Bean Latte are $11.95. All are made with real whisked matcha and can be ordered hot or iced at 2142 Kalakaua Ave.',
        },
      ],
    },
    cta: {
  ...
  ja: {
    ...
    definition: {
      ...
      text: '<strong>ワイキキで一番おいしい抹茶</strong>とは、既製の甘いインスタント粉ではなく、<strong>注文ごとに点てたて</strong>の本格的な石臼挽き日本産抹茶を、あなた好みのフレーバーで味わうことです。<strong>Kona Coffee Donut?</strong> の一番人気は<strong>ストロベリー抹茶（$11.95）</strong>。クリーミーで甘酸っぱく、写真映えも抜群です。純粋な味がお好みなら<strong>抹茶ラテ（クラシック・$9.95）</strong>が一番。マンゴー、ココナッツ、グァバ、バナナ、リリコイなどのトロピカルも、どれも<strong>アイス</strong>に、あるいは<strong>カフェインフリーのほうじ茶ベース</strong>にも変更可能 — すべてワイキキビーチから徒歩約5分です。',
    },
    history: {
      title: 'おいしい抹茶ドリンクの条件',
      ...
      items: [
        {
          ...
          answer: '一番人気の抹茶はストロベリー抹茶（$11.95）— 点てたての抹茶とミルクの上に、クリーミーで甘酸っぱいストロベリーの層。みんなに愛される一番人気で、最初に注文するのにおすすめの一杯です。純粋な抹茶の味をお求めなら、抹茶ラテ（クラシック・$9.95）から始めるのが一番です。',
        },
        {
          question: 'ワイキキでストロベリー抹茶はありますか？',
          answer: 'はい。ストロベリー抹茶（$11.95）は当店で一番人気の抹茶ドリンクで、本格点てたて日本産抹茶、ミルク、そして甘いストロベリーの層で作ります。カラカウア通りのKona Coffee Donut?、ワイキキビーチから徒歩約5分でお楽しみいただけます — ホットでもアイスでも。',
        },
        {
        ...
        },
        {
          ...
          answer: 'ほとんどの抹茶ラテは$9.95（クラシック、マンゴー、ココナッツ、グァバ、バナナ、リリコイ抹茶）。ストロベリー抹茶とあずきラテは$11.95です。すべて本格点てたて抹茶で作り、2142 Kalakaua Ave でホットでもアイスでもご注文いただけます。',
        },
      ],
    },
    cta: {
  ...
  ko: {
    ...
    definition: {
      title: '와이키키 최고의 말차는?',
      text: '<strong>와이키키 최고의 말차</strong>는 달콤한 기성 인스턴트 가루가 아니라, <strong>주문 즉시 갓 격불한</strong> 진짜 맷돌 간 일본 말차를 내가 좋아하는 플레이버로 즐기는 것입니다. <strong>Kona Coffee Donut?</strong> 의 가장 인기 메뉴는 <strong>딸기 말차($11.95)</strong> — 크리미하고 새콤달콤하며 사진발도 최고입니다. 순수한 맛을 원하신다면 <strong>클래식 말차 라테($9.95)</strong>가 정답. 망고, 코코넛, 구아바, 바나나, 리리코이 같은 트로피컬도, 무엇이든 <strong>아이스</strong>로, 혹은 <strong>카페인 프리 호지차 베이스</strong>로 바꿀 수 있습니다 — 모두 와이키키 비치에서 도보 약 5분.',
    },
    history: {
      title: '맛있는 말차 음료의 조건',
      ...
      items: [
        {
          ...
          answer: '가장 인기 있는 말차는 딸기 말차($11.95) — 갓 격불한 말차와 우유 위에 크리미하고 새콤달콤한 딸기 층입니다. 누구나 좋아하는 인기 메뉴이자 가장 먼저 주문하기를 추천하는 한 잔이죠. 순수한 말차 맛을 원하신다면, 클래식 말차 라테($9.95)로 시작하는 것이 가장 좋습니다.',
        },
        {
          question: '와이키키에서 딸기 말차가 있나요?',
          answer: '네. 딸기 말차($11.95)는 저희 베스트셀러 말차 음료로, 진짜 갓 격불한 일본 말차, 우유, 그리고 달콤한 딸기 층으로 만듭니다. 칼라카우아 애비뉴의 Kona Coffee Donut?, 와이키키 비치에서 도보 약 5분 거리에서 만나보세요 — 따뜻하게든 차갑게든.',
        },
        {
        ...
        },
        {
          ...
          answer: '대부분의 말차 라테는 $9.95입니다(클래식, 망고, 코코넛, 구아바, 바나나, 리리코이 말차). 딸기 말차와 아즈키 단팥 라테는 $11.95입니다. 모두 진짜 갓 격불한 말차로 만들며, 2142 Kalakaua Ave에서 따뜻하게든 차갑게든 주문하실 수 있습니다.',
        },
      ],
    },
    cta: {
  ...
  zh: {
    ...
    definition: {
      title: '威基基最好喝的抹茶是哪款？',
      text: '<strong>威基基最好喝的抹茶</strong>，是用真正的石磨日本抹茶<strong>现点现打</strong>——而非加糖的速溶粉——调成你喜欢的口味。在 <strong>Kona Coffee Donut?</strong>，我们最人气的一款是<strong>草莓抹茶（$11.95）</strong>：奶香浓郁、酸甜可口，还格外上镜。想要纯粹的味道？<strong>经典抹茶拿铁（$9.95）</strong>最正宗。再加上芒果、椰子、番石榴、香蕉或百香果等热带口味，任意一款都能做成<strong>冰饮</strong>，或换成<strong>无咖啡因的焙茶底</strong>——全都距威基基海滩约5分钟。',
    },
    history: {
      title: '一杯好抹茶的秘诀',
      ...
      items: [
        {
          ...
          answer: '我们最人气的抹茶是草莓抹茶（$11.95）——现打抹茶与牛奶之上，铺一层奶香酸甜的草莓。它是大众最爱，也是我们建议你最先点的一杯。如果想要纯粹的抹茶味，经典抹茶拿铁（$9.95）是最好的起点。',
        },
        {
          question: '威基基有草莓抹茶吗？',
          answer: '有。草莓抹茶（$11.95）是我们最畅销的抹茶饮品，用真正现打的日本抹茶、牛奶和一层香甜草莓制成。你可以在卡拉卡瓦大道的 Kona Coffee Donut? 找到它，距威基基海滩约5分钟步行——冷热皆有。',
        },
        {
          question: '可以点冰抹茶吗？',
        ...
        {
          question: '威基基的抹茶多少钱？',
          answer: '大多数抹茶拿铁是 $9.95（经典、芒果、椰子、番石榴、香蕉和百香果抹茶）。草莓抹茶和红豆拿铁是 $11.95。全部用真正现打的抹茶制作，可在 2142 Kalakaua Ave 点热饮或冰饮。',
        },
      ],
    },
    cta: {
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Our most popular matcha is the Strawberry Matcha ($11.95) — a creamy, sweet-tart layer of strawberry over freshly whisked matcha and milk. It\'s the crowd favorite and the one we recommend ordering first. If you want the pure taste of matcha, the Classic Matcha Latte ($9.95) is the best place to start.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Strawberry Matcha ($11.95) is our bestselling matcha drink, made with real whisked Japanese matcha, milk, and a sweet layer of strawberry. You\'ll find it at Kona Coffee Donut? on Kalākaua Ave, about a 5-minute walk from Waikiki Beach — hot or iced.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Most of our matcha lattes are $9.95 (Classic, Mango, Coconut, Guava, Banana, and Lilikoi Matcha). The Strawberry Matcha and Azuki Red Bean Latte are $11.95. All are made with real whisked matcha and can be ordered hot or iced at 2142 Kalakaua Ave.',
      },
    },
  ],
};
