...
export const menuItemCategories: MenuItemCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'Azuki Latte', image: matchaItem('matcha-azuki-latte'), price: '11.95' },
      { name: 'Strawberry Latte', image: matchaItem('matcha-strawberry-latte'), price: '11.95' },
      { name: 'Matcha Latte', image: matchaItem('matcha-latte'), price: '9.95' },
      { name: 'Hojicha Latte', image: matchaItem('matcha-hojicha-latte'), price: '9.95' },
      { name: 'Guava Matcha', image: matchaItem('matcha-guava'), price: '9.95' },
      { name: 'Lilikoi Matcha', image: matchaItem('matcha-lilikoi'), price: '9.95' },
      { name: 'Mango Matcha', image: matchaItem('matcha-mango'), price: '9.95' },
      { name: 'Coconut Matcha', image: matchaItem('matcha-coconut'), price: '9.95' },
      { name: 'Banana Matcha', image: matchaItem('matcha-banana'), price: '9.95' },
    ],
    addOns: DRINK_ADDONS,
  },
  {
    ...
    title: 'Smoothies',
    items: [
      { name: 'Açaí Berry', image: smoothieItem('smoothie-acai-berry'), price: '12.95' },
      { name: 'Strawberry Banana', image: smoothieItem('smoothie-strawberry-banana'), price: '12.95' },
      { name: 'Coconut Pineapple', image: smoothieItem('smoothie-coconut-pineapple'), price: '12.95' },
      { name: 'Mango Coconut Lilikoi', image: smoothieItem('smoothie-mango-coconut-lilikoi'), price: '12.95' },
    ],
    addOns: DRINK_ADDONS,
  },
  {
    ...
    detailSlug: 'bingsu',
    items: [
      { name: 'Azuki Bean', image: bingsuItem('bingsu-azuki-bean'), price: '15.95' },
      { name: 'Strawberry', image: bingsuItem('bingsu-strawberry'), price: '15.95' },
      { name: 'Pineapple', image: bingsuItem('bingsu-pineapple'), price: '15.95' },
      { name: 'Mango', image: bingsuItem('bingsu-mango'), price: '15.95' },
      { name: 'Ube', image: bingsuItem('bingsu-ube'), price: '15.95' },
      { name: 'Kona Coffee', image: bingsuItem('bingsu-kona-coffee'), price: '15.95' },
      { name: 'Green Tea', image: bingsuItem('bingsu-greentea'), price: '15.95' },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Açaí Oahu', image: acaiItem('acai-oahu'), price: '14.95 / 18.95' },
      { name: 'Açaí Paradise', image: acaiItem('acai-paradise'), price: '14.95 / 18.95' },
      { name: 'Açaí Colada', image: acaiItem('acai-colada'), price: '14.95 / 18.95' },
      { name: 'Papaya Special', image: acaiItem('acai-papaya'), price: '14.95 / 18.95' },
